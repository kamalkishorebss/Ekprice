...
class Edit_Services_Step1 extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            list: [],
        ...
        if (e == 's') {
            if (this.state.cat_id) {
                fetch(`https://www.ekprice.com/api/getSubCategories/${this.state.cat_id}`).then((response) => response.json()).then((json) => {
                    ...
                    this.setState({
                        categoryModal: true,
                        modalHeaderText: 'Sub_Categories',
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <BasicHeader {...this.props} title={"Edit Service"} />
                    ...
                    <ScrollView style={styles.listContainer} showsVerticalScrollIndicator={false}>
                        ...
                        <View style={[styles.sectionContainer, { marginTop: 10 }]}>
                            <View style={styles.innerContainer}>
                                ...
                                <Text style={styles.serviceValidateText}>{this.state.titleLength==''?'[Min 60 chars and Max 80 chars]':`${this.state.titleLength}/80`}</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(Edit_Services_Step1)